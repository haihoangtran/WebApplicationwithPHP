 ...
 * This code will allow the providers to register for the website.
 * Name: Michael Tran
 * Date: 11/29/2012
 * Date Approved:
 * Name of Approver:
        ...
        <form id='register' action='' method='post'
            ...
            <fieldset >
                ...
                <table border="0">
                    ...
                    <tr>
                    <select name="type">     
                        <option value = 'D'>D - Dietian</option>
                        <option value = 'I'>I - Internist</option>
                        <option value = 'E'>E - Exercise Specialist</option>
                    </select>
                    </tr>
                    <tr>
